...
@property (nonatomic, readonly) DynamicTypeLabel * leftLabel;
@property (nonatomic, readonly) DynamicTypeLabel * rightLabel;
...
SWIFT_CLASS("_TtC10SwiftUtils16DynamicTypeLabel")
